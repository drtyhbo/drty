...
common.mixin(FilterExpression.prototype, {
...
common.mixin(Parser.prototype, {
    ...
    parse: function () {
        ...
        if (stoppers.length) {
            throw Error('Tag not found: ' + stoppers.join(', '));
        }
...
common.mixin(Context.prototype, {
    get: function (name) {
...
common.mixin(Template.prototype, {
    render: function (o, callback, loadCallback) {
