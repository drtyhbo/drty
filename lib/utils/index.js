...
exports.eachChained = function(obj, eachCallback, doneCallback) {
	...
	(function next() {
		...
		var name = list.shift();
		eachCallback(name, obj[name], next, doneCallback);
	})();
}
...
exports.strptime = function(format, str) {
...
// Sweet recursive mkdir function written by Isaac Zimmitti Schlueter
// https://github.com/isaacs/npm/blob/master/lib/utils/mkdir-p.js
exports.mkdir = function(ensure, cb) {
  var fs = require('fs');
