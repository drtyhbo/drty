...
function validateError(test, field, value, code) {
	...
	try { field.validate(value); }
		...
		didThrow = true;
		test.ok(e instanceof drty.core.exceptions.ValidationError);      
		test.equal(e.code, code);
	}
	test.equals(didThrow, true);
}
...
module.exports = testCase({
	...
	'DecimalField': function(test) {	
		...
		test.doesNotThrow(function() { field.validate('10000000'); });
		test.doesNotThrow(function() { field.validate('9999999.99'); });
		test.doesNotThrow(function() { field.validate('26.0'); });

		test.throws(function() { field.validate('abcd'); }); // wtf
		test.throws(function() { field.validate('10000000.1'); }); // max
		test.throws(function() { field.validate('0'); }); // min
		test.throws(function() { field.validate('50.12345'); }); // max decimal places
		test.throws(function() { field.validate('9999999.1234'); }); // max digits
	...
	'TypedChoiceField': function(test) {
		...
		test.strictEqual(field.toJS('1'), '1');
		test.strictEqual(field.toJS('2'), '2');
		test.strictEqual(field.toJS(), null);
	...
	'SlugField': function(test) {
		...
		test.doesNotThrow(function() { field.validate('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_-'); });
		test.doesNotThrow(function() { field.validate('abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz'); });
		test.doesNotThrow(function() { field.validate('ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ'); });
		test.doesNotThrow(function() { field.validate('0123456789_-0123456789_-'); });
