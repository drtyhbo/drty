...
var Field = exports.Field = drty.Class.extend({
	...
	validate: function(value, cb) {
		if (value === undefined || value === '') {
			cb(this.isRequired()
				? new ValidationError('This field is required', 'required')
				: null);
		} else {
...
var URLField = exports.URLField = Field.extend({
	...
	initialize: function(options) {
		...
		if (!('verifyExists' in this._options) || this._options.verifyExists) {
			this.defaultValidators.push(validators.validateURLExists);
		}
	}
});
...
var ImageField = exports.ImageField = FileField.extend({
