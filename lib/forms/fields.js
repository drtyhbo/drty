...
var Field = exports.Field = new Class({
	initial: '',
...
var IntegerField = exports.IntegerField = new Class({
	Extends: Field,
	fieldType: 'integer',
...
var StringField = exports.StringField = new Class({
	Extends: Field,
	fieldType: 'string',
	defaultWidget: widgets.InputBox
});

var TextField = exports.Textfield = new Class({
	Extends: Field,
	fieldType: 'text',
	defaultWidget: widgets.TextArea	
});

var BooleanField = exports.BooleanField = new Class({
	Extends: Field,
	fieldType: 'boolean',
	defaultWidget: widgets.CheckBox	
});

var ChoiceField = exports.ChoiceField = new Class({
	Extends: Field,
	fieldType: 'choice'	,
