...
exports.formFromModel = function(Model, callback) {
	...
	drty.utils.eachChained(columns, function(name, column, next) {
		...
		switch(column._fieldType) {
			...
			case 'FloatField':
				prop[name] = new exports.FloatField(options);
				break;
			...
			case 'IPAddressField':
				prop[name] = new exports.IPAddressField(options);
				break;
			
			case 'URLField':
				prop[name] = new exports.URLField(options);
				break;
			...
			case 'NullBooleanField':
				prop[name] = new exports.NullBooleanField(options);
				break;
