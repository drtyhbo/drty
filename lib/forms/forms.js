...
An unbound Form contains a collection of unbound Fields.
An unbound Field contains a Widget. An unboard Widget renders

Form -> Field -> Widget -> HTML Form
     -> Field -> Widget -> HTML Form
     -> Field -> Widget -> HTML Form
*/
...
var Form = Class({
	...
	clean: function() {
		...
		for (var name in this.__meta.fields) {
			...
			this[name] = field.toJS(field.widget.toJS(this.dirtyValues[name]));
