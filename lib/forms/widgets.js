...
var Widget = exports.Widget = Class.extends({
...
var InputBox = exports.InputBox = Class.extends({
	Extends: Widget,
	type: 'text',
...
var HiddenInputBox = exports.HiddenInputBox = Class.extends({
	Extends: InputBox,
	type: 'hidden',
...
var TextArea = exports.TextArea = Class.extends({
	Extends: Widget,
...
var CheckBox = exports.CheckBox = Class.extends({
	Extends: Widget,
...
var ChoiceBox = exports.ChoiceBox = Class.extends({
	Extends: Widget,
