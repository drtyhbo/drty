...
var PositiveIntegerFieldMeta = exports.PositiveIntegerFieldMeta = ColumnMeta.extend({
	sqlType: 'integer',
	isUnsigned: function() { return true; }
});

var SmallIntegerFieldMeta = exports.SmallIntegerFieldMeta = ColumnMeta.extend({
	sqlType: 'smallint',
});

var PositiveSmallIntegerFieldMeta = exports.PositiveSmallIntegerFieldMeta = ColumnMeta.extend({
	sqlType: 'smallint',
	isUnsigned: function() { return true; }
});

var AutoFieldMeta = exports.AutoFieldMeta = PositiveIntegerFieldMeta.extend({
	isAutoIncrement: function() { return true; }
});

var FloatFieldMeta = exports.FloatFieldMeta = ColumnMeta.extend({
	sqlType: 'double',
});
...
var ForeignKeyMeta = exports.ForeignKeyMeta = IntegerFieldMeta.extend({
...
exports.getMetaForColumn = function(column) {
	var metaForType = {
		...
		'PositiveIntegerField': PositiveIntegerFieldMeta,
		'SmallIntegerField': SmallIntegerFieldMeta,
		'PositiveSmallIntegerField': PositiveSmallIntegerFieldMeta,
		'FloatField': FloatFieldMeta,
		'CharField': CharFieldMeta,
		'TextField': TextFieldMeta,
		'BooleanField': BooleanFieldMeta,
		'NullBooleanField': BooleanFieldMeta,
		'DateTimeField': DateTimeFieldMeta,
		'DateField': DateTimeFieldMeta,
