...
Model.__onExtend__ = function(NewModel, properties) {
	...
	if (!NewModel.pk) {
		NewModel.pk = columns['id'] = new AutoField({primaryKey: true});
...
var AutoField = exports.AutoField = Field.extend({
...
var PositiveIntegerField = exports.PositiveIntegerField = Field.extend({
	_fieldType: 'PositiveIntegerField'
});

var SmallIntegerField = exports.SmallIntegerField = Field.extend({
	_fieldType: 'SmallIntegerField'
});

var PositiveSmallIntegerField = exports.PositiveSmallIntegerField = Field.extend({
...
var EmailField = exports.EmailField = CharField.extend({
	...
	initialize: function(maxLength, params) {
		maxLength = maxLength || 75;
		this.parent(drty.utils.merge({maxLength: maxLength}, params));
	}
});
...
var NullBooleanField = exports.NullBooleanField = BooleanField.extend({
	_fieldType: 'NullBooleanField',
	initialize: function(params) {
		this.parent(drty.utils.merge({null: true}, params));		
	}
});
...
var DateField = exports.DateField = Field.extend({
